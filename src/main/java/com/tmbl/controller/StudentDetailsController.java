...
public class StudentDetailsController {
	...
	public ResponseEntity<String> addStudentDetails(@Valid @RequestBody StudentDetailsRequest student, BindingResult bindingResult) throws StudentDetailsException {
	...
	public ResponseEntity<StudentDetailsRequest> getStudentDetails(@PathVariable(value = "studentId") int id) throws StudentDetailsException  {
		StudentDetailsRequest list = studentRepo.findOne(id);
		return new ResponseEntity<StudentDetailsRequest>(list, HttpStatus.OK);
	}

	@DeleteMapping(value = "{studentId}")
	public ResponseEntity<Integer> deleteStudentDetail(@PathVariable(value = "studentId") int id)  throws StudentDetailsException  {
